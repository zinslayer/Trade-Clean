            ...
            if desc_column in df.columns:
                ...
                if cleaning_mode == "Manual Cleaning":
                    ...
                    if unmapped_names:
                        ...
                        with col1:
                            # Add Select All checkbox with proper state handling
                            ...
                            # Determine default selection based on checkbox state
                            if select_all:
                                default_selection = unmapped_names
                            else:
                                default_selection = []
                            ...
                            selected_names = st.multiselect(
                                ...
                                key=f"sources_{select_all}"  # Add checkbox state to key to force re-render
                            )
...
with tab3:
    ...
    with col_controls:
        ...
        if st.button("🗑️ Clear All", type="secondary"):
            ...
            st.session_state.value_chain_edges = []
            st.session_state.node_counter = 0
            st.success("✅ Cleared all nodes and connections!")
